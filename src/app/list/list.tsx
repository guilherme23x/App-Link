import { Image, View, TouchableOpacity, FlatList, Modal, Text, Alert, Linking, ImageBackground } from "react-native"
            ...
            <View style={styles.containerContent}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity activeOpacity={0.6} onPress={() => router.navigate("/add")}>
                        <MaterialIcons name="add" size={32} color={colors.blue[900]} />
                    </TouchableOpacity>
                </View>
